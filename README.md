...
**NOTE:** This uses [Twitter Site Streams](https://dev.twitter.com/docs/streaming-apis/streams/site) which at the time of writing (15 Oct 2013) are in a limited, whitelisted beta.
...
* A BERG Cloud publication and its OAuth tokens (see the [Push API documentation](http://remote.bergcloud.com/developers/reference/push)).
...
All the settings are required unless marked optional.
	...
	# has 'Read, write and direct messages' permissions, and access to Site
	# Streams.
